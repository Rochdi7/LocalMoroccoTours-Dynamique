 ...
 @php
     $seoTitle = ($activity->title ?? 'Morocco Activity') . ' | Authentic Morocco Adventures';
     $seoDesc = \Illuminate\Support\Str::limit(trim(strip_tags($activity->overview ?? '')), 155);
     $seoDesc = $seoDesc !== '' ? $seoDesc : 'Book ' . ($activity->title ?? 'this Morocco activity') . ' with Authentic Morocco Adventures — a local expert guide for an authentic Morocco experience.';
     $seoImage = ($activity->getFirstMediaUrl('cover') ?: null);
 @endphp
         ...
         <div class="container">
                 ...
                 <div data-anim="slide-up delay-1" class="col-lg-8">
                     <div class="">
                         <div class="row x-gap-10 y-gap-10 items-center">
                             ...
                             @if ($activity->free_cancellation_flag)
                                 <div class="col-auto">
                                 ...
                                 <div class="row x-gap-20 y-gap-20 items-center">
                                     ...
                                     <div class="col-auto">
                                         <div class="d-flex items-center">
                                             ...
                                             {{ number_format($activity->booked_count) }} booked
                                         </div>
                                     </div>
                                 </div>
                             </div>
                         ...
                         <div class="col-lg-3 col-6">
                             <div class="d-flex items-center">
                                 ...
                                 <div class="ml-10">
                                     ...
                                     <div class="text-14 text-light-2 lh-16">{{ $activity->duration }}</div>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="col-lg-3 col-6">
                             <div class="d-flex items-center">
                                 ...
                                 <div class="ml-10">
                                     ...
                                     <div class="text-14 text-light-2 lh-16">{{ $activity->group_size }} people</div>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="col-lg-3 col-6">
                             <div class="d-flex items-center">
                                 ...
                                 <div class="ml-10">
                                     ...
                                     <div class="text-14 text-light-2 lh-16">{{ $activity->age_range }}</div>
                                 </div>
                             </div>
                         </div>
                     ...
                     <p class="mt-20">{{ $activity->overview }}</p>
                     ...
                     <div class="bg-white rounded-12 shadow-2 py-30 px-30 md:py-20 md:px-20 mt-30">
                         ...
                         <div class="mb-20">
                             <h3 class="text-24 text-accent-1 fw-700">{{ $activity->title }}</h3>
            ...
            border-radius: 5px;">
                     ...
                     <div class="contactForm y-gap-30 pt-30">
                         <form method="POST" action="{{ route('front.activities.leaveReview', $activity->slug) }}"
                                     ...
                                     <a href="{{ route('front.activities.show', $similarActivity->slug) }}"
                                         ...
                                         <div class="tourCard__header">
                                             <div class="tourCard__image ratio ratio-28:20">
                                                 <img src="{{ $similarActivity->getFirstMediaUrl('cover') ?: ($similarActivity->getFirstMediaUrl('gallery') ?: asset('assets/images/default-image.png')) }}"
                                                     alt="{{ $similarActivity->title }}" class="img-ratio rounded-12" loading="lazy">
                                             </div>
                                         ...
                                         <div class="tourCard__content px-10 pt-10">
                                             <div class="tourCard__location d-flex items-center text-13 text-light-2">
                                                 ...
                                                 {{ $similarActivity->location->name ?? 'Unknown Location' }}
                                             </div>

                                             <h3 class="tourCard__title text-16 fw-500 mt-5">
                                                 <span>{{ Str::limit($similarActivity->title, 50) }}</span>
                                             </h3>
