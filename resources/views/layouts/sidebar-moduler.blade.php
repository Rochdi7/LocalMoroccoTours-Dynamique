        ...
        <div class="navbar-content">
            ...
            <div class="card nav-action-card bg-brand-color-4">
                <div class="card-body" style="background-image: url('/build/images/layout/nav-card-bg.svg')">
                    ...
                    <a href="https://codesommet.com/" class="btn btn-primary" target="_blank">Go to help Center</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="dropdown">
                            <a href="#" class="arrow-none dropdown-toggle" data-bs-toggle="dropdown"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 me-2">
                                        <h6 class="mb-0">{{ $auth->name ?? 'Unknown User' }}</h6>
                                        <small
                                            class="text-body">{{ ucfirst($auth->getRoleNames()->first() ?? 'User') }}</small>
                                    </div>
